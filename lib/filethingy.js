...
FileThingy.prototype.processDirectories = function(done) {
  ...
  (function next() {
    ...
    fs.mkdir(path, function(err) {
      ...
      self.processFiles(dir, path, function() {
        // self.queue.execute(function(results) {
...
FileThingy.prototype.processFiles = function(dir, path, done) {
  var self = this;
  var files = this.structure[dir];
